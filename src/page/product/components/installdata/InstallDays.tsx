...
const InstallDays: FC = () => {
  ...
  const fetchInstallAgeData = async () => {
    try {
      ...
      setBarError(null);
      const response = await getDauByInstallAge();
  ...
  return (
    <div className="h-[400px] p-6 bg-white rounded-md shadow-lg flex relative z-10 overflow-visible">
